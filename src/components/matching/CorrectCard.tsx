    ...
    <View style={styles.backGround}>
      <Animated.View style={[animatedCorrect, styles.card]}>
        <TouchableOpacity
          ...
          <Image
            style={styles.image}
            source={props.word.hasImage ? {uri: Config.BaseUrl+props.word.image} : require('../../assets/placeholder.png')}
          />
        </TouchableOpacity>
      </Animated.View>
    </View>
